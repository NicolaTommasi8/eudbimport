...
cap label var P3_P51G_EC "Final consumption expenditure and gross fixed capital formation - extra cost"
cap label var P3_P51G_FC "Final consumption expenditure and gross fixed capital formation - full cost"
cap label var P3_CREP_EC "Final consumption expenditure of cleaner and resource efficient products - extra cost"
cap label var P3_CREP_FC "Final consumption expenditure of cleaner and resource efficient products - full cost"
cap label var P51G_CA_EC "Gross fixed capital formation for characteristics activities - extra cost"
cap label var P51G_CA_FC "Gross fixed capital formation for characteristics activities - full cost"
cap label var P51G_CREP_EC "Gross fixed capital formation in cleaner and resource efficient products - extra cost"
cap label var P51G_CREP_FC "Gross fixed capital formation in cleaner and resource efficient products - full cost"
cap label var P3_P51G_CREP_EC "Final consumption expenditure and gross fixed capital formation in cleaner and resource efficient products - extra cost"
cap label var P3_P51G_CREP_FC "Final consumption expenditure and gross fixed capital formation in cleaner and resource efficient products - full cost"
...
cap label var EP_P51G_CREP_EC "Gross fixed capital formation in cleaner and resource efficient products for environmental protection - extra cost"
cap label var EP_P51G_CREP_FC "Gross fixed capital formation in cleaner and resource efficient products for environmental protection - full cost"

...
cap label var ENT_IND_NAT "Independent national enterprises"
cap label var EG_NAT "National enterprise groups (all resident enterprise groups)"
cap label var MNEG "Multinational enterprise groups (domestically and foreign-controlled)"
cap label var MNEG_DOMC "Domestically controlled multinational enterprise groups"
cap label var MNEG_FORC "Foreign-controlled multinational enterprise groups"
cap label var MNEG_EU "Multinational enterprise groups controlled from the EU"
cap label var MNEG_NEU "Multinational enterprise groups controlled from the non-EU"
